...
export function FloatingToolbarAi({
  ...
  const submitPrompt = useCallback(
    async (prompt: string) => {
      ...
      const systemMessage = `You are a rewriting engine. Rewrite only the user's input text clearly and professionally. Do not explain, label, or format.`;
      ...
      setMessages([
        ...
        {
          role: "assistant",
          content: result, // result is a plain string
        },
      ]);
      setAiState("complete");
    },
